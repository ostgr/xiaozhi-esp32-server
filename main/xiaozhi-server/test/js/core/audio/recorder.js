...
export class AudioRecorder {
    ...
    createScriptProcessor() {
        try {
            ...
            log('Using ScriptProcessorNode as fallback successful', 'warning');
    ...
    async start() {
        ...
        try {
            ...
            log('Please record at least 1-2 seconds of audio to ensure sufficient data is captured', 'info');
            ...
            if (this.websocket && this.websocket.readyState === WebSocket.OPEN) {
                ...
                log(`Sent recording start message: ${JSON.stringify(listenMessage)}`, 'info');
